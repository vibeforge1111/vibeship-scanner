		...
		<div class="navbar-right">
			...
			{:else if $auth.user}
				<div class="navbar-auth-status">
					<button class="navbar-signout" onclick={handleSignOut} aria-label="Sign out">
			...
			{:else}
				<button class="navbar-github-btn" onclick={handleGitHubLogin} disabled={authLoading} aria-label="Sign in with GitHub for private repos">
...
<footer class="site-footer">
	<div class="footer-top">
		...
		<div class="footer-social">
			<a href="https://github.com/vibeforge1111/vibeship-scanner" target="_blank" rel="noopener noreferrer" class="footer-icon-btn">
	...
	<div class="footer-bottom">
		<a href="https://vibeship.co" class="footer-logo">
			<img src="/assets/images/logo.png" alt="vibeship" class="footer-logo-icon">
			<span>vibeship</span>
		</a>
